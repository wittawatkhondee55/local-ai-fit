...
const TH: Record<string, string> = {
  ...
  ranking_note: "* คะแนนหลักเป็นค่าประเมินโดยประมาณ (ใช้จัดอันดับ) ไม่ใช่ตัวเลขทางการ · ป้าย Aider = คะแนน coding จริง (pass-rate) จาก aider.chat เฉพาะโมเดลที่มีในลีดเดอร์บอร์ด อัปเดตอัตโนมัติ",
...
const EN: Record<string, string> = {
  ...
  ranking_note: "* Main scores are rough estimates (used for ordering), not official numbers · the Aider tag = real coding pass-rate from aider.chat, for models listed there, auto-updated.",
